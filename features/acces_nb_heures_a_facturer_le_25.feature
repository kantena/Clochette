...
Fonctionnalité: Accès au nombre d'heures à facturer par clients le 25 du mois
  ...
  Scénario: un développeur rentre son relevé de travail pour un client à différentes périodes (mois/année)
    ...
    Et Hector ayant déclarer 10 jours de travail pour le client "Cour des Comptes" pour le 7 ème mois de l'année 2009
    Et Hector ayant déclarer 10 jours de travail pour le client "Cour des Comptes" pour le 4 ème mois de l'année 2010
    Lorsque l'on va sur la page d'acceuil
